...
celltype_qlf_d56_ctr_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(0, 1, -1, 0, 0, 0))
celltype_qlf_d56_bmp_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(-1, 1, 0, 0, 0, 0))

# D97 analysis
celltype_qlf_d97_ctr_vs_bmp <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, 1, 0,-1))
celltype_qlf_d97_ctr_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, 0, 1, -1))
celltype_qlf_d97_bmp_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, -1, 1, 0))
...
celltype_qlf_d35_ctr_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(0, 1, -1, 0, 0, 0))
celltype_qlf_d35_bmp_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(-1, 1, 0, 0, 0, 0))
...
# D56 analysis
celltype_qlf_d56_ctr_vs_bmp <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, 1, 0, -1))
celltype_qlf_d56_ctr_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, 0, 1, -1))
celltype_qlf_d56_bmp_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, -1, 1, 0))
...
# D35 analysis
celltype_qlf_d35_ctr_vs_bmp <- glmQLFTest(celltype_fit, contrast=c(1, 0, -1, 0, 0, 0, 0, 0, 0))
celltype_qlf_d35_ctr_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(0, 1, -1, 0, 0, 0, 0, 0, 0))
celltype_qlf_d35_bmp_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(-1, 1, 0, 0, 0, 0, 0, 0, 0))

# D56 analysis
celltype_qlf_d56_ctr_vs_bmp <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, 1, 0, -1, 0, 0, 0))
celltype_qlf_d56_ctr_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, 0, 1, -1, 0, 0, 0))
celltype_qlf_d56_bmp_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, -1, 1, 0, 0, 0, 0))
#
# D97 analysis
celltype_qlf_d97_ctr_vs_bmp <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, 0, 0, 0, 1, 0, -1))
celltype_qlf_d97_ctr_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, 0, 0, 0, 0, 1, -1))
celltype_qlf_d97_bmp_vs_fgf <- glmQLFTest(celltype_fit, contrast=c(0, 0, 0, 0, 0, 0, -1, 1, 0))
